...
# *
# *--------------------------------------------------------
# * File Name : formats/L3Mobile_PS_SM.py
# * Created : 2012-08-28
    ...
    def __init__(self, with_options=True, **kwargs):
        ...
        self.extend([ \
            ...
            Type4_TLV('ProtConfig', ReprName='Protocol configuration options', \
                      T=0x27, V='\x80'),
            Type1_TV('Type', ReprName='Request type', T=0xA, V=1, \
...
class DEACTIVATE_PDP_CONTEXT_REQUEST(Layer3):
    ...
    def __init__(self, with_options=True, **kwargs):
        ...
        self.extend([ \
            ...
            Type4_TLV('ProtConfig', ReprName='Protocol configuration options', \
                      T=0x27, V='\x80'),
            Type4_TLV('MBMSProtConfig', ReprName='MBMS protocol configuration options', \
                      T=0x35, V='\0'),
            ])
        self._post_init(with_options, **kwargs)
    ...
    def __init__(self, with_options=True, **kwargs):
        ...
        self.extend([ \
            ...
            Type4_LV('MBMSCap', ReprName='Supported MBMS bearer capbilities', \
                     V='\0'),
            Type4_LV('PDPAddr', ReprName='Requested multicast address', V='\0\x01'),
